...
goeaobj.print_results(goea_results1, pval=0.05)

# Rodar análise de enriquecimento para grupo 2 em relação ao background
goea_results2 = goeaobj.run_study(genes_grupo2)
goeaobj.print_results(goea_results2, pval=0.05)

# Salvar os resultados manualmente em arquivos TSV
f1 = open("/home/lgef/InterTests/go_enrichment_grupo1.tsv", "w")
goeaobj.wr_tsv(f1, goea_results1)
f1.close()

f2 = open("/home/lgef/InterTests/go_enrichment_grupo2.tsv", "w")
goeaobj.wr_tsv(f2, goea_results2)
f2.close()
