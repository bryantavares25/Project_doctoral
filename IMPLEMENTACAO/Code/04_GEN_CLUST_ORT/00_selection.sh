...
# Uma árvore 
# Strain | OG | GENEID >>> pega o ID do gene >>> $dir/Documentos/GitHub/Project_doctoral/IMPLEMENTACAO/Gene_clusters/M_flocculare/ATCC27716/genomic_gene_coc.bed
...
for line in $(cat $mfc_list); do
    for og in ${OG[@]}; do
        ...
        awk 'BEGIN {OFS = "\t"} if $1 ~ /MFC_${line}_genes/ $2 ~ /${og}_genes/ print $0' $mfc
    done
done
...
while read -r line; do
    ...
    mfc_cb=/home/bryan/Documentos/GitHub/Project_doctoral/IMPLEMENTACAO/Gene_clusters/M_flocculare/$line/genomic_gene_coc.bed
    mfc_cbc=/home/bryan/Documentos/GitHub/Project_doctoral/IMPLEMENTACAO/Gene_clusters/M_flocculare/$line/genomic_gene_coc_clean.bed
