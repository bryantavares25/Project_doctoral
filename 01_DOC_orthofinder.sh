...
direcgen="/home/lgef/Documentos/GitHub/Project_doctoral/"
direcort="dsada"

#f="/home/lgef/Documentos/GitHub/Project_doctoral/Orthofinder_db"
extension.extension.vim_cmd+cvim_cmd+c
# Search MHP
for genome in "${genomesmhp[@]}"; do cd cp ${direc}Genomes/Mesomycoplasma_hyopneumoniae/${genome}/ncbi_dataset/data/*/protein.faa ${direc}Orthofinder_db/${genome}_proteins_fasta; done
# Search MFC
